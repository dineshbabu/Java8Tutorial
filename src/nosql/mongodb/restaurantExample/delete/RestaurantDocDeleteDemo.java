...
package nosql.mongodb.restaurantExample.delete;
...
public class RestaurantDocDeleteDemo {
	...
	public static void main(String[] args) throws ParseException{
		...
		try{
			...
			//Delete one record
//			Document docToDelete = new Document("name", "St Albans cuisine");
//			mongoCollection.deleteOne(docToDelete);
//			queryRestaurants(mongoCollection, docToDelete);
			
			//Delete more than one record
			Document docsToDelete = new Document("name", java.util.regex.Pattern.compile("St Albans cuisine"));
			mongoCollection.deleteMany(docsToDelete);
			queryRestaurants(mongoCollection, docsToDelete);
